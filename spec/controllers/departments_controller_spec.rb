...
RSpec.describe DepartmentsController, type: :controller do
  ...
  let(:invalid_attributes) {
    FactoryGirl.attributes_for(:department, name: nil)
  }
  ...
  describe "GET #index" do
    it "assigns all departments as @departments" do
      ...
      expect(assigns(:records)).to eq([department])

      expect(assigns(:options)).to have_key(:colHeaders)
      expect(assigns(:options)).to have_key(:columns)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        FactoryGirl.attributes_for(:department, name:"new_name")
      }
