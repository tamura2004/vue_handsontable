...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { col: @seat.col, job: @seat.job, name: @seat.name, row: @seat.row, state_id: @seat.state_id } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { col: @seat.col, job: @seat.job, name: @seat.name, row: @seat.row, state_id: @seat.state_id } }
