...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post costs_url, params: { cost: { cost: @cost.cost, month: @cost.month, project_id: @cost.project_id } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { cost: @cost.cost, month: @cost.month, project_id: @cost.project_id } }
