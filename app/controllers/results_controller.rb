class ResultsController < ApplicationController
  ...
  ATTRIBUTES = %w(month group_number group_name outsource_code company_name member_number member_name project_number project_name proc_number proc_name cont_number cont_name system_number cost:float cost_minute)
