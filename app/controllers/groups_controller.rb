class GroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group.save
        format.html { redirect_to @group, status: :ok, notice: 'Group was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @group.update(group_params)
        format.html { redirect_to @group, status: :ok, notice: 'Group was successfully updated.' }
        format.json { render :show, status: :ok, location: @group }
      else
  ...
  def destroy
    @group.destroy
    respond_to do |format|
      format.html { redirect_to groups_url, status: :ok, notice: 'Group was successfully destroyed.' }
